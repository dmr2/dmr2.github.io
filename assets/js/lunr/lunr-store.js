var store = [{
        ...
        "title": "🌡️📈 Rising Cooling Demand in San Diego County: Insights from New Climate Data 🔍☀️",
        "excerpt":"Cooling degree days (CDDs) are useful for approximating air conditioning demand ❄️, both in current and future climates. They are calculated by comparing the daily average temperature to a base temperature, typically 65°F (18.3°C). CDDs help us understand the extent to which outside temperatures surpass a comfortable threshold, thereby indicating...","categories": ["Heat"],
        "tags": [],
        "url": "/heat/sd-county-cdds/",
        "teaser": "/assets/images/header_image.jpg"
      }]
